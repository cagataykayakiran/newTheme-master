...
class ControllerExtensionModuleZemezSlideshow extends Controller {
	public function index($setting) {
		...
		$this->document->addScript('catalog/view/javascript/zemez894/swiper/swinit.js', 'footer');
		$this->document->addScript('catalog/view/javascript/zemez894/swiper/swmin.js');
		...
		if (isset($setting['slides'])) {
			...
			if ($vid) {
				$this->document->addScript('catalog/view/javascript/zemez894/swiper/jquery.vide.min.js');
			}
		}
