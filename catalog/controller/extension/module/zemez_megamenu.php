...
class ControllerExtensionModuleZemezMegaMenu extends Controller
{
							...
							switch ($column['content']) {
								...
								if ($results) {
									foreach ($results as $product_info) {
										$list .= "<li><a href=\"" . $this->url->link('product/product', '&product_id=' . $product_info['product_id'], true) . "\">" . $product_info['name'] . "</a></li>";
									}
								}
								break;
								case 3:
								...
								if (isset($cats_2[$column_categories[$column['category_id']]])) {
									$list .= "<li class=\"submenu_title\"><a href=\"" . $this->url->link('product/category', 'path=' . $cats_2[$column_categories[$column['category_id']]]['category_id'], true) . "\">" . $cats_2[$column_categories[$column['category_id']]]['name'] . "</a></li>";
									...
									foreach ($cats_3 as $cats_3_key => $cats_3_value) {
										...
										$list .= "<li><a href=\"" . $this->url->link('product/category', 'path=' . $cats_3_value['category_id'], true) . "\">" . $cats_3_value['name'] . "</a></li>";
									}
								}
								break;
								case 2:
								...
								if (isset($cats_2[$column_categories[$column['category_id']]])) {
									$list .= "<li><a href=\"" . $this->url->link('product/category', 'path=' . $cats_2[$column_categories[$column['category_id']]]['category_id'], true) . "\">" . $cats_2[$column_categories[$column['category_id']]]['name'] . "</a></li>";
								...
								foreach ($cats_2 as $cat) {
									$list .= "<li><a href=\"" . $this->url->link('product/category', 'path=' . $cat['category_id'], true) . "\">" . $cat['name'] . "</a></li>";
								}
								break;
								case 0:
						...
						foreach ($menu_item['column'] as $column_id => $column) {
							...
							switch ($column['content']) {
								...
								if (isset($cats_2[$column_categories[$category_id]])) {
									$list .= "<li class=\"submenu_title\"><a href=\"" . $this->url->link('product/category', 'path=' . $cats_2[$column_categories[$category_id]]['category_id'], true) . "\">" . $cats_2[$column_categories[$category_id]]['name'] . "</a></li>";
								...
								if (isset($cats_2[$column_categories[$category_id]])) {
									$list .= "<li><a href=\"" . $this->url->link('product/category', 'path=' . $cats_2[$column_categories[$category_id]]['category_id'], true) . "\">" . $cats_2[$column_categories[$category_id]]['name'] . "</a></li>";
	...
	function getCatTree($category_id = 0)
	{
		...
		foreach ($categories as $category) {
			...
			$category_data .= "<li><a href=\"" . $href . "\"" . $class . ">" . $name . "</a>" . $parent . "</li>";

		}

		return strlen($category_data) ? "<ul class=\"simple_menu\">" . $category_data . "</ul>" : "";
	}
}